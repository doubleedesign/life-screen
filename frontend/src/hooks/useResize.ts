import { MutableRefObject, useMemo, useEffect, useState, RefObject } from 'react';
...
export function useResize(ref: MutableRefObject<HTMLElement> | RefObject<HTMLElement>, deps: unknown[]): Dimensions {
